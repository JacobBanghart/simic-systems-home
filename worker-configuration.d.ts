/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f0e920575c6254ae65eda2559ca432f4)
// Runtime types generated with workerd@1.20260623.1 2024-11-01 nodejs_compat
interface __BaseEnv_Env {
	PRODUCT_CACHE: KVNamespace;
	simic_systems_tfstate: R2Bucket;
	CONTACT_EMAIL: SendEmail;
	ASSETS: Fetcher;
	STRIPE_SECRET_KEY: string;
	STRIPE_WEBHOOK_SECRET: string;
	STRIPE_PRODUCTION_KEY: string;
